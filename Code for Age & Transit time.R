...
##################################### Age and transit time
SA2s1=systemAge(A=A2s1, u=u2s1)
SA2s2=systemAge(A=A2s2, u=u2s2)
SA3s1=systemAge(A=A3s1, u=u3s1)
SA3s2=systemAge(A=A3s2, u=u3s2)
SA3s3=systemAge(A=A3s3, u=u3s3)
SA3s4=systemAge(A=A3s4, u=u3s4)
SA3s5=systemAge(A=A3s5, u=u3s5)
...
########################################## plot age
plot(xlim=c(0, 200),ylim=c(-0.0005, 0.04),SA2s1$systemAgeDensity, type="l", col='#c0c0c0', xlab="Age", ylab="Density function",lwd=2)
