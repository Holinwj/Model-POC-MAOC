...
C05_2ps_resp = readRDS("./2_pool_model/C05_2ps_resp.rds")
k2s1=c(C05_2ps_resp$FMEmodel$par[1]*365,C05_2ps_resp$FMEmodel$par[2]*365)
A2s1=diag(-k2s1)
A2s1[2,1]=k2s1[1]*C05_2ps_resp$FMEmodel$par[3]
u2s1=matrix(c(100,0),ncol=1)

############################### +litter 2-pool_fit respiration
L05_2ps_resp = readRDS("./2_pool_model/L05_2ps_resp.rds")
k2s2=c(L05_2ps_resp$FMEmodel$par[1]*365, L05_2ps_resp$FMEmodel$par[2]*365)
A2s2=diag(-k2s2)
A2s2[2,1]=k2s2[1]*L05_2ps_resp$FMEmodel$par[3]
u2s2=matrix(c(100,0),ncol=1)

############################### control 3-pool
C05_3ps_15litter = readRDS("./3_pool_assumptions/C05_3ps_15litter.rds")
k3s1=c(C05_3ps_15litter$FMEmodel$par[1] *365,
       C05_3ps_15litter$FMEmodel$par[2] *365,
       C05_3ps_15litter$FMEmodel$par[3] *365)
A3s1=diag(-k3s1)
A3s1[2,1]=k3s1[1]*C05_3ps_15litter$FMEmodel$par[4]
A3s1[3,2]=k3s1[2]*C05_3ps_15litter$FMEmodel$par[5]
A3s1[3,1]=k3s1[1]*C05_3ps_15litter$FMEmodel$par[6]
u3s1=matrix(c(100,0,0),ncol=1)

############################### litter-addition 3-pool
L05_3ps_15litter = readRDS("./3_pool_assumptions/L05_3ps_15litter.rds")
k3s2=c(L05_3ps_15litter$FMEmodel$par[1] *365,
       L05_3ps_15litter$FMEmodel$par[2] *365,
       L05_3ps_15litter$FMEmodel$par[3] *365)
A3s2=diag(-k3s2)
A3s2[2,1]=k3s2[1]*L05_3ps_15litter$FMEmodel$par[4]
A3s2[3,2]=k3s2[2]*L05_3ps_15litter$FMEmodel$par[5]
A3s2[3,1]=k3s2[1]*L05_3ps_15litter$FMEmodel$par[6]
