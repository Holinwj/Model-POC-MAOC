...
M1=threepFit(rt, initial, inipars=c(0.3, 0.005, 0.08, 0.03, 0.02, 0.03)) 
...
outputs <- data.frame(
  Object   = "L05",
  k1       = L05$FMEmodel$par[1],
  k2       = L05$FMEmodel$par[2],
  k3       = L05$FMEmodel$par[3],
  a21      = L05$FMEmodel$par[4],
  a32      = L05$FMEmodel$par[5],
  a31      = L05$FMEmodel$par[6],
  ms       = L05$FMEmodel$ms,
  AIC      = L05[["AIC"]],
  meanTT   = L05$TT$meanTransitTime,
  medianTT = L05$TT$quantiles[2]
)
